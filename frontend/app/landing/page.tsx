...
export default function LandingPage() {
  ...
  const features = [
    { icon: '🎯', title: 'Smart Organization', description: 'Priorities, tags, advanced filtering', gradient: 'from-blue-500 to-cyan-500' },
    { icon: '🎮', title: 'Interactive Management', description: 'Drag & drop, bulk actions, shortcuts', gradient: 'from-purple-500 to-pink-500' },
    { icon: '📝', title: 'Rich Task Details', description: 'Subtasks, notes, file attachments', gradient: 'from-indigo-500 to-purple-500' },
    { icon: '✨', title: '3D Visual Effects', description: 'Glassmorphism, smooth animations', gradient: 'from-pink-500 to-rose-500' },
    { icon: '🌙', title: 'Perfect Dark Mode', description: 'Flicker-free dark/light themes', gradient: 'from-blue-600 to-indigo-600' },
    { icon: '📊', title: 'Data Management', description: 'Export/import, templates, analytics', gradient: 'from-green-500 to-emerald-500' },
    { icon: '🎯', title: 'Focus Mode', description: 'Distraction-free with Pomodoro', gradient: 'from-orange-500 to-yellow-500' },
    { icon: '🤖', title: 'AI Intelligence', description: 'Claude-powered chatbot', gradient: 'from-cyan-500 to-blue-500' },
    { icon: '⚡', title: 'Lightning Fast', description: '<200ms responses, 60fps', gradient: 'from-yellow-500 to-orange-500' }
  ]
      ...
      <footer className="relative z-10 px-6 py-10 border-t border-white border-opacity-10">
        <div className="max-w-7xl mx-auto text-center text-white">
          ...
          <p className="text-gray-500">
            Powered by <span className="font-semibold bg-gradient-to-r from-blue-400 to-purple-400 text-transparent bg-clip-text">Syeda Alishba Fatima</span>
          </p>
